...
import { QUESTION_TIERS } from "@/lib/types";
...
const baseQuestion = {
  ...
  /*
   * ما يطلبه السؤال: تعريف أم تطبيق أم تفريق بين مفهومين متقاربين. مطلوب
   * في البنك لأن ترتيب الجلسة يقوم عليه، ومهمَل في التدريبات والامتحانات
   * حيث الترتيب هو ترتيب الورقة. اشتراطه في البنك في المستورد لا هنا،
   * لأن الـ schema لا يعرف نوع العنصر الذي يُستورَد إليه.
   */
