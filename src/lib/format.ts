...
export function reviewScope(position: number): string {
  switch (position) {
    ...
    case 2:
      return "أسئلة تخلط الفصل الثالث والرابع: تطبيقات الويب، وتصميم المواقع والوسائط.";
    case 3:
      return "أسئلة على الترم الأول كله: المجتمع، والأمن، وتطبيقات الويب، وتصميم الوسائط.";
    case 4:
      return "أسئلة تخلط الفصل الخامس والسادس: جمع البيانات وتنقيتها، والتحليل والتواصل.";
    case 5:
      return "أسئلة على الترم الثاني كله: البيانات، والتحليل الإحصائي، والتعلم الآلي.";
    case 6:
      return "أسئلة على المنهج من أوله لآخره: من المجتمع والأمن لحد نماذج اللغة.";
    default:
      return "أسئلة تخلط أكتر من فصل — مش فصل جديد.";
  }
}
...
/**
 * مستوى سؤال البنك بكلمة يقرؤها الطالب.
 *
 * "تفريق" لا "فخ": الكلمة نفسها تقول له ما المطلوب منه — أن يفرّق بين
 * مفهومين متقاربين — بدل أن توحي بأن السؤال يتصيّده.
 */
export const QUESTION_TIER_LABELS: Record<string, string> = {
  definition: "تعريف",
  application: "تطبيق",
  trap: "تفريق",
};
