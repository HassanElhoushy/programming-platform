-- =============================================================================
-- منصة البرمجة — 14: نوع الفصل (فصل أو مراجعة شاملة)
--
-- شغّل هذا الملف بعد 13_lesson_kind.sql.
--
-- المراجعة التي تغطي فصلين ليست ابنة أحدهما بل أختاً لهما. ووضعها داخل
-- الفصل الثاني يجبر السطر على الكذب: "الفصل الثاني · مراجعة الفصل" وهي
-- على فصلين.
--
-- فصلٌ نوعه "مراجعة" هو الحاوية الصحيحة: يجمع المراجعات العابرة للفصول —
-- ختام الأول والثاني، وختام الثالث والرابع، والمراجعة النهائية — ولا يأخذ
-- رقماً في العرض لأن ترتيبه بين الفصول لا معنى له.
--
-- سلسلة الصلاحيات لا تتغير إطلاقاً: فصل ← دروس ← ملفات وامتحانات.
-- =============================================================================
...
alter table public.chapters
  add column if not exists kind public.chapter_kind not null default 'chapter';


-- ---------------------------------------------------------------------------
-- دالة المراجعة تُعيد نوع الفصل أيضاً، لتكتب صفحة النتيجة السطر نفسه.
-- ---------------------------------------------------------------------------
